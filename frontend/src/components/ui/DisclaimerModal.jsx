      ...
      >
        ...
        >
          ...
          <p className="text-[var(--color-muted)] text-base leading-relaxed mb-4">
            The predictions shown on this platform are generated by machine learning
            models trained on historical S&P 500 data.{' '}
          ...
          <p className="text-[var(--color-muted)] text-base leading-relaxed mb-8">
            This system is built for academic and analytical purposes only. Do not use
            these predictions to make real investment or trading decisions. Markets are
            affected by events that no historical model can anticipate.
          </p>
