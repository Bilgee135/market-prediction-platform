  ...
  return (
    <div className="mx-auto px-8 py-12" style={{ maxWidth: '1100px' }}>
      ...
      <div className="mb-8">
        ...
        {latest && (
          <p className="text-[0.9rem] font-light mt-3" style={{ color: 'var(--color-muted)' }}>
            Latest predicted close:{' '}
            <strong style={{ color: 'var(--color-ink)', fontWeight: 500 }}>
              ${parseFloat(latest.predicted_close).toLocaleString('en-US', { minimumFractionDigits: 2 })}
            </strong>
            {' '}· week of {new Date(latest.prediction_date).toLocaleDateString('en-GB')}
          </p>
        )}
      </div>
      ...
      <div className="flex gap-6 items-start">
        ...
        <div className="flex-1 min-w-0">
          ...
          >
            {/* Timeframe buttons - only shown for line chart */}
          ...
          >
            ...
            <div className="flex flex-col gap-4">
              {[
                ...
                <div key={label} className="flex justify-between items-center pb-3 border-b last:border-b-0 last:pb-0"
                  style={{ borderColor: 'var(--color-border)' }}>
