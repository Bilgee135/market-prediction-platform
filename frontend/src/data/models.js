...
export const MODELS = [
  ...
  },
  {
    ...
    type: 'Ensemble',
    description:
      'An ensemble of decision trees trained on random subsets of the data. Each tree votes on the prediction and the majority result wins, reducing overfitting compared to a single tree.',
  ...
  },
  {
    ...
    type: 'Ensemble',
    description:
      'A gradient boosting algorithm that builds trees sequentially, each one correcting the errors of the last. Highly effective on structured tabular data and widely used in competitive forecasting.',
  ...
  },
  {
    ...
    type: 'Kernel',
    description:
      'Finds the optimal boundary around the data that maximises the margin of tolerance. Works well in high-dimensional spaces and is effective when the number of features is close to the number of samples.',
  ...
  },
  {
    ...
    type: 'Linear',
    description:
      'A classical statistical model that fits a straight line through the data to minimise squared errors. Included as a baseline — any model that cannot beat it needs further work.',
